...
<link rel="preload" href="/fonts/bodoni-moda-700.woff2" as="font" type="font/woff2" crossorigin />
...
@font-face{ font-family:"Bodoni Moda"; font-style:normal; font-weight:400 500;
  font-display:swap; src:url("/fonts/bodoni-moda-500.woff2") format("woff2"); }
@font-face{ font-family:"Bodoni Moda"; font-style:normal; font-weight:600 700;
...
:root{
  ...
  --ink:#2a2320; --ink-muted:#7a6a5c; --border:#d6af87; --border-light:#ead9c2;
  ...
  /* Two faces. Bodoni Moda is the display serif from the brand kit and takes
     the headings, the recipe names and anything that is a title; Alegreya
     Sans takes everything a person actually reads a sentence of, which
     includes the buttons and the fields, because a Didone at 13px on a phone
     is a decoration rather than a label. Both fall back to a stack that is
     already installed, so the app is never waiting on a download to be
     legible. */
  --font-display: "Bodoni Moda", Georgia, "Iowan Old Style", "Palatino Linotype", serif;
...
.welcome-wrap .brand-logo{ max-width:330px; margin:0 0 6px; }
...
.tag{ font-size:11px; background:var(--sage-soft); color:var(--sage-dark); padding:3px 9px; border-radius:999px; display:inline-block; }
.tag-row{ display:flex; flex-wrap:wrap; gap:5px; align-items:center; }
.owner-badge{ font-size:11px; color:var(--accent-dark); background:var(--accent-soft); border-radius:999px; padding:3px 9px; display:inline-block; }
...
.pill-shared{ color:var(--sage-dark); border-color:var(--sage-line); background:var(--sage-soft); }
...
.change-banner .btn{ background:var(--field); border-color:#e6cf9a; color:#6b4a10; }
...
/* What is on screen between the shell arriving and the first render. It is
   the logo on the page's own white, centred, so the app names itself before
   it has anything else to say. Removed by the first paint, which replaces
   everything inside #app. */
.boot-splash{ position:fixed; inset:0; display:flex; align-items:center;
...
.modal-error{ background:var(--danger-soft); border:1px solid var(--danger-line); color:var(--danger-dark); font-size:13px; padding:9px 11px; border-radius:8px; margin-bottom:12px; }
...
.cal-chip{ display:block; width:100%; text-align:left; font-size:9.5px; line-height:1.25; padding:2px 3px;
  border:0; border-radius:4px; background:var(--sage-soft); color:var(--sage-dark); cursor:pointer;
...
.sched-banner{ display:flex; align-items:center; gap:10px; flex-wrap:wrap;
  ...
  font-size:13px; color:var(--sage-dark); margin-bottom:12px; }
...
.sched-cell.on .sched-num{ color:var(--sage-dark); }
...
.sched-chip{ display:block; font-size:8.5px; line-height:1.3; padding:0 2px; border-radius:3px;
  background:var(--sage-soft); color:var(--sage-dark); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
...
.mark-star.on{ color:var(--sage-dark); border-color:var(--sage); background:var(--sage-soft); }
.mark-later.on{ color:var(--sage-dark); border-color:var(--sage); background:var(--sage-soft); }
.mark-pin.on{ color:var(--accent); border-color:var(--accent); background:var(--accent-soft); }
...
<body>
<div id="app"><div class="boot-splash"><img src="/logo.png" alt="Kindred Cupboard" /></div></div>
...
const FONT_B64 = {
  "bodoni-moda-500": "",
  "bodoni-moda-700": "",
